...
class MemberGetMemberJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $html = view('emails.customers.invite-friends')->with([
        ...
        $json = [
            ...
            'nm_subject'      => 'Presenteie com 50 pontos um amigo e cada amigo que se cadastrar você ganha 10 pontos!',
