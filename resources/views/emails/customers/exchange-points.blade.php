                                                            ...
                                                            <tr>
                                                               <td class="mcnImageBlockInner" style="padding:0px" valign="top">
                                                                  <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;" width="100%">
                                                                     <tbody>
                                                                        <tr>
                                                                           <td class="mcnImageContent" style="padding-right: 0px; padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top"><img align="center" alt="" class="mcnImage" src="http://qifinanceiro.com.br/wp-content/uploads/2016/11/presente.jpg" style="max-width:494px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" width="494"></td>
                                                                        </tr>
                                                                     </tbody>
                                                                  </table>
                                                               </td>
                                                                              ...
                                                                              <tbody>
                                                                                 <tr>
                                                                                    <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                                                                       <div style="text-align: center;"><span style="font-size:16px"><span style="color:#000000"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><strong>{{ $customer_name }}, </strong> você fez um pedido de troca de pontos que está sendo avaliado pela nossa equipe. </div>
                                                                                          <div style="text-align: left;">&nbsp;
                                                                                          <h3 style="color: rgb(0, 0, 0); text-align:left;">Seus dados</h3>
                                                                                          <strong style="color: rgb(0, 0, 0);"> Nome:</strong><span style="color:#000000"> {{ $data->customer->fullname }}</span><br>
                                                                                          <strong style="color: rgb(0, 0, 0);"> E-mail:</strong><span style="color:#000000"> {{ $data->customer->email }}</span><br>
                                                                                          <strong style="color: rgb(0, 0, 0);"> Telefone:</strong><span style="color:#000000"> {{ $data->customer->phone_number }}</span><br>
                                                                                          <strong style="color: rgb(0, 0, 0);"> CPF:</strong><span style="color:#000000"> {{ $cpf }}</span><br>                                                                              
                                                                                    </div>   
                                                                                    </td>
                                                                                 </tr>
                                                                                 
                                                                                 <tr>
                                                                                    <td class="mcnTextContent" style="text-align: justify; font-size:12px; padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                                                                       <br><br>
                                                                                       <strong>ATENÇÃO: </strong>Caso ocorra algum erro na entrega por motivos de divergência nos dados informados na troca, o produto <strong>não será entregue</strong> e a pontuação <strong>não voltará para sua conta</strong>.
                                                                                       O produto solicitado será entregue no endereço cadastrado pelo usuário com prazo de entrega contado em dias úteis, não incluindo sábados, domingos e feriados.
                                                                                       Você pode consultar os prazos e demais informações em nossos <a href="https://sweetbonus.com.br/termos-e-condicoes">termos e condições (seção 6)</a>.
                                                                                    </td>
                                                                                 </tr>                                                                                 
                                                                              </tbody>
                                                                           </table>
                                                            ...
                                                            <tr>
                                                               <td align="center" class="mcnButtonBlockInner" style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top">
                                                                  <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #00ADD8;">
                                                                     <tbody>
                                                                        <tr>
                                                                           <td align="center" class="mcnButtonContent" style="font-family: Helvetica; font-size: 18px; padding: 18px;" valign="middle"><a class="mcnButton " href="{{ env('APP_URL') }}/login/" target="_blank" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;" target="_self" title="Quero responder agora">Quero ganhar mais pontos</a></td>
                                                                        </tr>
                                                                     </tbody>
                                                                  </table>
                                                               </td>
                                                                              ...
                                                                              <tbody>
                                                                                 <tr>
                                                                                    <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top"><span style="font-size:16px"><em><strong>Sweet © {{ now()->year }}</strong> | <a href="http://e.allin.sweetbonusclub.com/bendar/?atmca=6927568&amp;atmme=7&amp;atmte=1&amp;atmso=ck&amp;utm_content=234376697" target="_blank">Política de privacidade</a> | Todos os direitos reservados.</em></span><br>
                                                                                       ...
                                                                                       <br>
                                                                                       <span style="font-size:16px">Sempre que tiver algum problema e precisar contactar o <strong>SAC</strong> por favor informe que estava respondendo a pesquisa número <strong>SPCS201807</strong>.<br>
                                                                                       <br>
                                                                                       Caso tenha algum problema com o link - <a href="{{ env('APP_URL') }}/login/" target="_blank">clicar nesse link</a><br>
                                                                                       <br>
                                                                                       <p> </p>
...
<p> </p>
      ...
      <img src="{{ env('APP_URL') }}/pixelemail?email=##nm_email##&origin=exchange-points" width="1" height="1" />
      <img src="{{ env('APP_STORAGE') }}/pixeis-opened-email?email=##nm_email##&id=##nm_id##" width="1" height="1" />
   </body>
</html>
