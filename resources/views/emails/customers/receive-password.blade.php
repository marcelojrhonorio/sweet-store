                                                            ...
                                                            <tr>
                                                               <td class="mcnImageBlockInner" style="padding:0px" valign="top">
                                                                  <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;" width="100%">
                                                                     <tbody>
                                                                        <tr>
                                                                           <td class="mcnImageContent" style="padding-right: 0px; padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top"><img align="center" alt="" class="mcnImage" src="https://image.freepik.com/vetores-gratis/armario_53876-25496.jpg" style="max-width:300px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" width="494"></td>
                                                                        </tr>
                                                                     </tbody>
                                                                  </table>
                                                               </td>
                                                                              ...
                                                                              <tbody>
                                                                                 <tr>
                                                                                    <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top"><br>
                                                                                       <div style="text-align: center;"><span style="font-size:16px"><span style="color:#000000"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><strong>{{ $name }}, </strong>voce solicitou a geração automática de uma nova senha. <br> Segue abaixo:</font></font></span></span><strong style="color: rgb(0, 0, 0);"></strong></div>
                                                                                       <div style="text-align: center;">&nbsp;<br><br><br>
                                                                                          <strong style="color:#494949; font-size:30px;">{{ $password }}</strong><span style="color:#000000; text-align: center;"></span>
                                                            ...
                                                            <tr>
                                                               <td align="center" class="mcnButtonBlockInner" style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top">
                                                                  <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #00ADD8;">
                                                                     <tbody>
                                                                        <tr>
                                                                           <td align="center" class="mcnButtonContent" style="font-family: Helvetica; font-size: 18px; padding: 18px;" valign="middle"><a class="mcnButton " href="{{ env('APP_URL') }}/login/verify/{{ $data['data']['customer']['confirmation_code'] }}" target="_blank" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;" target="_self" title="Quero responder agora">Acessar a loja agora</a></td>
                                                                        </tr>
                                                                     </tbody>
                                                                  </table>
                                                               </td>
...
<p> </p>
      ...
      <img src="{{ env('APP_URL') }}/pixelemail?email=##nm_email##&origin=receive-password" width="1" height="1" />
