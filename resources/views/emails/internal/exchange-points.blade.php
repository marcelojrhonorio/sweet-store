...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:v="urn:schemas-microsoft-com:vml">
   ...
   <body>
                                                                              ...
                                                                              <tbody>
                                                                                 <tr>
                                                                                    <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                                                                       <br><div style="text-align: center;"><span style="font-size:16px"><span style="color:#000000"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><strong>Prezados, </strong>segue abaixo uma nova solicitação de <strong>troca de pontos</strong>:</font></font></span></span><strong style="color: rgb(0, 0, 0);"></strong></div><br>
                                                                                       <div style="text-align: center;">&nbsp;</div>
                                                                                       <div style="text-align: left;"><span style="color:#66cc99;">
                                                                                        <h3 style="color: rgb(0, 0, 0); text-align:left;">Dados do usuário</h3>
                                                                                        <strong style="color: rgb(0, 0, 0);"> ID:</strong><span style="color:#000000"> {{ $data->customer->id }}</span><br>
                                                                                        ...
                                                                                        <strong style="color: rgb(0, 0, 0);"> Pontuação anterior:</strong><span style="color:#000000"> {{ $points['previous_ballance'] }}</span><br>
                                                                                        <strong style="color: rgb(0, 0, 0);"> Pontuação final:</strong><span style="color:#000000"> {{ $points['final'] }}</span><br><br>
                                                                                        <h3 style="color: rgb(0, 0, 0); text-align:left;">Dados do produto</h3>
                                                                                        <strong style="color: rgb(0, 0, 0);"> ID:</strong><span style="color:#000000"> {{ $data->product_service->id }}</span> <br>
                                                                                        <strong style="color: rgb(0, 0, 0);"> Descrição:</strong><span style="color:#000000"> {{ $data->product_service->description }}</span><br>
                                                                                        <strong style="color: rgb(0, 0, 0);"> Pontos:</strong><span style="color:#000000"> {{ $data->product_service->points }}</span>
                                                                                    </span></div>
      ...
      <img src="https://store.sweetbonus.com.br/pixelemail?email=##nm_email##" width="1" height="1" />
